...
Java_com_lib_imageCompress_NativeCompress_nativeCompressBitmap(JNIEnv *env, jclass type,
...
JNIEXPORT jint JNICALL
Java_com_lib_imageCompress_NativeCompress_nativeCompressBitmapWithWidthAndHeight(JNIEnv* env,
                                                       jobject thiz, jobject bitmap, int w, int h, int quality,
                                                       jbyteArray dstFile_, jboolean optimize) {
    AndroidBitmapInfo androidBitmapInfo;
    BYTE* pixelsColor;
    int ret;
    BYTE* data;
